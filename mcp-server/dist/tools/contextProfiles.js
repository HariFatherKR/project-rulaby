...
export async function handleContextProfileTool(name, args) {
    ...
    switch (name) {
        ...
        case 'update_context_profile': {
            ...
            if (args.instructions !== undefined)
                profile.instructions = args.instructions;
            if (args.constraints !== undefined)
                profile.constraints = args.constraints;
...
//# sourceMappingURL=contextProfiles.js.map